...
router.post('/', multerUpload_1.multerUpload.single('terminalFeedImage'), parseBody_1.parseBody, (0, validateRequest_1.default)(terminalFeed_validation_1.terminalFeedValidation.createSchema), (0, auth_1.default)(client_1.UserRoleEnum.USER), terminalFeed_controller_1.terminalFeedController.createTerminalFeed);
