...
const updateMyProfileIntoDB = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateUserRoleStatusIntoDB = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const changePassword = (user, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isCorrectPassword = yield bcrypt.compare(
      payload.oldPassword,
      userData.password,
    );
...
const verifyOtpInDB = bodyData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (userData === null || userData === void 0 ? void 0 : userData.otp) !==
      bodyData.otp
    ) {
      throw new AppError_1.default(
        http_status_1.default.CONFLICT,
...
// verify otp
const verifyOtpForgotPasswordInDB = bodyData =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userData = yield prisma_1.default.user.findUnique({
      where: { email: bodyData.email },
    });
...
const socialLoginIntoDB = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
      ...
      const accessToken = yield (0, generateToken_1.generateToken)(
        ...
        config_1.default.jwt.access_expires_in,
      );
...
const updatePasswordIntoDb = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userData = yield prisma_1.default.user.findUnique({
      where: { email: payload.email },
    });
