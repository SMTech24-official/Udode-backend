...
router.post('/', (0, auth_1.default)(client_1.UserRoleEnum.ADMIN, client_1.UserRoleEnum.SUPER_ADMIN), (0, validateRequest_1.default)(terminal_validation_1.terminalValidation.createSchema), terminal_controller_1.terminalController.createTerminal);
...
router.delete('/:id', (0, auth_1.default)(client_1.UserRoleEnum.ADMIN, client_1.UserRoleEnum.SUPER_ADMIN), terminal_controller_1.terminalController.deleteTerminal);
